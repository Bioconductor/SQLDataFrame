...
2. `union()@dbconcatKey` not efficient.  --done!
...
9. BiocGenerics:::replaceSlots()  -- done!
10. *_join no S4 generics. Should we keep S3 method or add S4 generic? 
11. show() of rbind(ss11, ss21, ss31, ss22) slow. But after
