## rbind now is kind of expensive, although it passes queries to SQL
## level, still it takes time to write a new database table if the
## input objects are big in dimensions.
